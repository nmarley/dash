...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_STRICT_GOBJECT_VALIDATION:        r = SPORK_15_STRICT_GOBJECT_VALIDATION_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_STRICT_GOBJECT_VALIDATION:        return SPORK_15_STRICT_GOBJECT_VALIDATION_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_15_STRICT_GOBJECT_VALIDATION")        return SPORK_15_STRICT_GOBJECT_VALIDATION;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_STRICT_GOBJECT_VALIDATION:        return "SPORK_15_STRICT_GOBJECT_VALIDATION";
        default:
